<template>
  ...
  right: auto !important;">
     ...
     <div class="instafeed-post-image" v-else-if="this.type === 'CAROUSEL_ALBUM'" style="width: 60%;height: 100%;float: left">
      ...
      <div class="description">
       ...
       <div class="box-content">
         ...
         <div class="products-tagging">
           <object>
             <a  id="search" data-picture-id="17984454994934934">
               <b>
                 <button @click="tagProduct" class="btn primary">Tag products</button>
               </b></a></object></div><div class="tagging-message" id="tagging-17984454994934934">
          ...
          <div v-for="item in list_tagged_product" class="tagged-products" style="margin-bottom: 1rem;">
            ...
            <div class="tagged-products-buttons" style="text-align: center;">
              <object class="product-title">
                <a href="">{{item.name}}</a>
                <a href="#"><button class="tagged-buy-button" tabindex="-1">Shop Now</button></a></object>
            </div>
